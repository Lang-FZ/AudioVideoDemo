...
private let lang_key:String = "AudioVideoDemoLanguage"
public let Language_Changed_Notification:Notification.Name = Notification.Name.init("AudioVideoDemoLanguageChanged")
